  ...
  return (
    <>
      <div
        ...
        data-tooltip-content={t("chat-history.change-text-size")}
        aria-label={t("chat-history.change-text-size")}
      ...
      >
        ...
        >
          <div className="w-full flex-col text-left flex pointer-events-none">
            <div className="text-white text-xs">{t("chat-history.small-text-size")}</div>
          </div>
        </button>
        ...
        >
          <div className="w-full flex-col text-left flex pointer-events-none">
            <div className="text-white text-sm">{t("chat-history.normal-text-size")}</div>
          </div>
        </button>
        ...
        >
          <div className="w-full flex-col text-left flex pointer-events-none">
            <div className="text-white text-[16px]">{t("chat-history.large-text-size")}</div>
          </div>
        </button>
      </div>
    </div>
