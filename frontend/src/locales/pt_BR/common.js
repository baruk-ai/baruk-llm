const TRANSLATIONS = {
  ...
  account: {
    "edit-label": "Editar conta",
    "update-label": "Atualizar conta",
    username: "Usuário",
    "username-placeholder": "Apelido do usuário",
    "username-description": "O nome de usuário deve conter apenas letras minúsculas, números, sublinhados e hifens, sem espaços",
    password: "Senha",
    "new-password": "Nova senha",
    "password-placeholder": "Senha do usuário",
    "password-description": "A senha deve ter pelo menos 8 caracteres",
    "initial-password-placeholder": "User's initial password",
    "preferred-language": "Idioma da interface",
    "profile-picture": "Foto do perfil",
    "remove-profile-picture": "Remover foto do perfil",
    "add-user": "Adicionar",
    "add-user-instance": "Adicionar a conta",
    role: "Perfil",
    "role-default": "Padrão",
    "role-manager": "Gerente",
    "role-administrator": "Administrador",
    "after-create-user-msg": "Depois de criar um usuário, ele precisará acessar o sistema com seu login inicial para obter acesso.",
  ...
  welcomeMessage: {
    part1:
      "Bem-vindo ao Chat inDoc, Chat inDoc é uma ferramenta de IA da Baruk que transforma qualquer documento em conhecimento de um chatbot que você pode consultar e conversar.",
    part2:
      "Chat inDoc é a platforma poderosa capaz de trabalhar com OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB e outros serviços em um pacote organizado sem complicações para aumentar sua produtividade em 100x.",
    part3:
      "Chat inDoc é plataforma que faltava para desbloquear o conhecimento armazenado em documentos da sua empresa.",
    learnMore: "Saiba mais no site da Baruk",
    user1: "Como eu começo?!",
    part4:
      'É simples. A base de conhecimento é organizada em grupos que chamamos de "Workspaces". Workspaces são grupos de arquivos, documentos, imagens, PDFs e outros arquivos que serão transformados em algo que os LLMs podem entender e usar em conversas.\n\nVocê pode adicionar e remover arquivos a qualquer momento.',
    createWorkspace: "Crie seu primeiro workspace",
    user2:
      "Como posso interagir com os meus documentos?",
    part5:
      "Chat inDoc oferece duas maneiras de conversar com seus dados:\n\n<i>Consulta:</i> Seus chats retornarão dados ou inferências encontradas com os documentos em seu workspace ao qual tem acesso. Adicionar mais documentos ao Workspace o torna mais inteligente!\n\n<i>Conversacional:</i> Seus documentos + seu histórico de chat em andamento contribuem para o conhecimento do LLM ao mesmo tempo. Ótimo para adicionar informações em tempo real baseadas em texto ou correções e mal-entendidos que o LLM possa ter.\n\nVocê pode alternar entre qualquer modo \n<i>no meio da conversa!</i>",
    user3: "Uau, isso soa incrível, deixe-me experimentar já!",
    part6: "Divirta-se!",
    starOnGithub: "Dar estrela no GitHub",
    contact: "Contato Baruk",
  },
  ...
  general: {
    ...
    message: {
      ...
      body: "os benefícios do Chat inDoc",
    },
    pfp: {
  ...
  appearance: {
    ...
    message: {
      ...
      user: "usuário",
      message: "mensagem",
      assistant: "Assistente de Chat Chat inDoc",
  ...
  api: {
    title: "Chaves API",
    description:
      "As chaves API permitem que o titular acesse e gerencie programaticamente esta instância do Chat inDoc.",
  ...
  llm: {
    ...
    description:
      "Estas são as credenciais e configurações para seu provedor preferido de chat e incorporação de LLM. É importante que essas chaves estejam atualizadas e corretas, caso contrário, o Chat inDoc não funcionará corretamente.",
  ...
  transcription: {
    ...
    "warn-start":
      "Usar o modelo whisper local em máquinas com RAM ou CPU limitados pode travar o Chat inDoc ao processar arquivos de mídia.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "A incorporação é o processo de transformar texto em vetores. Essas credenciais são necessárias para transformar seus arquivos e prompts em um formato que o Chat inDoc possa usar para processar.",
    provider: {
      title: "Provedor de Incorporação",
      description:
        "Não é necessária configuração ao usar o mecanismo de incorporação nativo do Chat inDoc.",
    },
  },
  ...
  vector: {
    ...
    description:
      "Estas são as credenciais e configurações de como sua instância do Chat inDoc funcionará. É importante que essas chaves estejam atualizadas e corretas.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Proteja sua instância do Chat inDoc com uma senha. Se você esquecer esta senha, não há método de recuperação, então certifique-se de salvar esta senha.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "Esta é a sua configuração de como os provedores de terceiros conectados e o Chat inDoc tratam seus dados.",
    llm: "Seleção de LLM",
  ...
  audio: {
    speech_provider: {
      title: "Preferência de conversão de fala em texto",
      description:
        "Aqui você pode especificar que tipo de provedores de texto para fala e de fala para texto você gostaria de usar em sua experiência Chat inDoc. Por padrão, usamos o suporte integrado do navegador para esses serviços, mas você pode querer usar outros.",
      subtitle: "Provedor",
    ...
    saving: "Salvando...",
    savechanges: "Atualizado com sucesso",
    search: "Pesquisar provedores de conversão de fala em texto",
    native_provider: "Sistema nativo",
    native_provider_description: "Usa o serviço STT integrado do seu navegador, se suportado.",
    preferences_saving_error_msg: "Falha ao salvar preferências",
    preferences_saving_success_msg: "Preferências de conversão de fala em texto salvas com sucesso."
  },

  "custom-site-settings": {
    title: "Configurações Personalizadas do Site",
    description:
      "Altere o conteúdo da aba do navegador para personalização e identidade visual.",
    "tab-title": {
      title: "Título da Aba",
      description: "Defina o título da aba para quando o aplicativo for aberto em um navegador.",
      placeholder: "Chat inDoc | Chatbot para documentos"
    },
    "tab-favicon": {
      title: "Favicon do Site",
      description: "Defina uma URL para uma imagem a ser usada no seu favicon",
  ...
  "language-preference": {
    ...
    "description-language":
      "Selecione o idioma preferido para interface do Chat inDoc, quando aplicável."
  },

  "custom-app": {
    "title": "Nome do Aplicativo",
    "description":
      "Defina um nome de aplicativo personalizado que será exibido na página de login."
  },

  "support-email": {
    "title": "E-mail do Suporte",
    "description":
      "Defina o endereço de e-mail de suporte que aparece no menu do usuário enquanto estiver conectado a esta instância.",
    "placeholder": "suporte@baruk.ai"
  },

  "chat-history": {
    "welcome": "Bem vindo ao seu Chat inDoc.",
    "send-msg": "Envie uma mensagem",
    "send-msg-tooltip": "Envie a mensagem",
    "reset-tooltip": "Limpe o histórico do chat e inicie um novo bate-papo",
    "command-tooltip": "Ver todos os comandos de barra disponíveis para bate-papo",
    "attach": "Anexo",
    "attach-tooltip": "Anexar um arquivo a este chat",
    "add-new-preset": "Adicionar nova predefinição",
    "change-text-size": "Alterar tamanho do texto",
    "small-text-size": "Pequeno",
    "normal-text-size": "Normal",
    "large-text-size": "Grande",
    "view-agents": "Veja todos os agentes disponíveis que você pode usar para bater papo.",
    "agents-tooltip": "Veja todos os agentes disponíveis que você pode usar para bater papo.",
    "default-agent": "o agente padrão para este espaço de trabalho.",
    "custom-agents": "",
    "speak": "Fala",
    "speak-tooltip": "Envie seu áudio",
  },
