  ...
  #defaultMeta() {
    return [
      ...
      },
      {
        tag: "title",
        props: null,
        content: "Chat inDoc | Chatbot para documentos",
      },
      ...
      {
        tag: "meta",
        props: { property: "og:url", content: "https://www.baruk.ai" },
      },
      {
        tag: "meta",
        props: {
      ...
      {
        tag: "meta",
        props: { property: "twitter:url", content: "https://www.baruk.ai" },
      },
      {
        tag: "meta",
        props: {
    ...
    if (customTitle === null && faviconURL === null) {
      ...
      this.#customConfig = [
        ...
        },
        {
          ...
          content:
            customTitle ??
            "Chat inDoc | Chatbot para documentos",
        },
      ];
    }
